...
export const type2Questions: Question[] = [
  ...
  },
  {
    ...
    text: '평소에 연락이 뜸해지면 먼저 드는 생각은 내가 필요 없어졌나 하는 것이다.',
  ...
  },
  {
    ...
    typeId: 2,
    facet: 't2-need-radar',
    text: '평소에 모임에 들어서면 먼저 눈에 들어오는 것은 표정이 어두운 사람이다.',
    sourceId: 'palmer-1988',
    origin: 'authored',
    reverse: false,
    rationale:
  ...
  },
  {
    ...
    typeId: 2,
    facet: 't2-need-radar',
    text: '평소에 대화할 때 먼저 눈에 들어오는 것은 상대가 말하지 않은 기분이다.',
    sourceId: 'palmer-1988',
    origin: 'authored',
    reverse: false,
    rationale:
  ...
  },
  {
    ...
    text: '평소에 내 일정이 빠듯해도 남의 부탁을 먼저 처리하는 편이다.',
