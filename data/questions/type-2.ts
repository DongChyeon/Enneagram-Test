...
export const type2Questions: Question[] = [
  {
    ...
    text: '평소에 가까운 사람이 나를 필요로 할 때 내 자리가 분명해져요.',
  ...
  },
  {
    ...
    typeId: 2,
    facet: 't2-being-needed',
    text: '지난 몇 년간 대체로 누가 나를 찾아 부탁해 올 때 반가운 마음이 먼저 들었어요.',
    sourceId: 'riso-hudson-wisdom',
    origin: 'authored',
    reverse: false,
    rationale:
  ...
  },
  {
    ...
    text: '평소에 연락이 뜸해지면 내가 필요 없어졌나 하는 생각이 먼저 들어요.',
  ...
  },
  {
    ...
    typeId: 2,
    facet: 't2-rejection-fear',
    text: '평소에 해줄 것이 없는 자리에서는 내 몫이 줄어든 느낌이 들어요.',
    sourceId: 'riso-hudson-wisdom',
    origin: 'authored',
    reverse: false,
    rationale:
    ...
    authoredBy: 'worker-items-a',
    copyrightReview: { verdict: 'clear', reviewedBy: 'worker-review-5', note: '"해줄 것이 없는 자리"와 "내 몫이 줄어든 느낌"이라는 자체 비유로 2번의 필요받음 욕구를 간접 표현했어요.' },
  },
  {
    id: 'q2-05',
    typeId: 2,
    facet: 't2-need-radar',
    text: '평소에 모임에 들어서면 표정이 어두운 사람이 먼저 눈에 들어와요.',
    sourceId: 'palmer-1988',
    origin: 'authored',
    reverse: false,
    rationale:
  ...
  },
  {
    ...
    typeId: 2,
    facet: 't2-need-radar',
    text: '평소에 대화할 때는 상대가 말하지 않은 기분에 먼저 눈이 가요.',
    sourceId: 'palmer-1988',
    origin: 'authored',
    reverse: false,
    rationale:
    ...
    authoredBy: 'worker-items-a',
    copyrightReview: { verdict: 'clear', reviewedBy: 'worker-review', note: '비언어 정서 읽기를 "말하지 않은 기분"으로 표현해 공감 자기평가형 문항과 문형을 달리했어요.' },
  },
  {
    id: 'q2-07',
    typeId: 2,
    facet: 't2-self-sacrifice',
    text: '평소에 내 일정이 빠듯해도 남의 부탁부터 먼저 처리하곤 해요.',
    ...
    authoredBy: 'worker-items-a',
    copyrightReview: { verdict: 'clear', reviewedBy: 'worker-review-5', note: '자기 일정과 타인 부탁의 처리 순서라는 행동 선택으로 표현해 "남을 돕는 것을 좋아한다"류 진술을 피했어요.' },
  },
  {
    id: 'q2-08',
    typeId: 2,
    facet: 't2-self-sacrifice',
    text: '평소에 여유가 없을 때는 남의 사정보다 내 사정을 먼저 챙겨요.',
    sourceId: 'naranjo-1994',
    origin: 'authored',
    reverse: true,
    rationale:
  ...
  },
  {
    ...
    text: '평소에 내가 챙긴 만큼 돌아오지 않으면 서운함이 오래가요.',
    ...
    authoredBy: 'worker-items-a',
    copyrightReview: { verdict: 'clear', reviewedBy: 'worker-review-5', note: '"챙긴 만큼 돌아오지 않으면 서운함이 오래간다"는 한국어 정서 관용 표현으로 보답 기대의 좌절을 기술했어요.' },
  },
  {
    id: 'q2-10',
    typeId: 2,
    facet: 't2-unreturned-resentment',
    text: '지난 몇 년간 대체로 도움을 준 뒤에는 돌아오는 것을 잊고 지냈어요.',
