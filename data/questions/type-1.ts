...
export const type1Questions: Question[] = [
  {
    ...
    typeId: 1,
    facet: 't1-standards',
    text: '평소에 아무도 안 보는 부분까지 제대로 해두어야 마음이 놓여요.',
  ...
  },
  {
    ...
    typeId: 1,
    facet: 't1-standards',
    text: '평소에 웬만한 일은 대충 넘어가도 괜찮다고 여겨요.',
    sourceId: 'riso-hudson-wisdom',
    origin: 'authored',
    reverse: true,
    rationale:
  ...
  },
  {
    ...
    typeId: 1,
    facet: 't1-flaw-fear',
    text: '평소에 지적을 들으면 허술해 보였겠다는 생각이 먼저 들어요.',
  ...
  },
  {
    ...
    typeId: 1,
    facet: 't1-flaw-fear',
    text: '평소에 내 몫을 제대로 못 했다는 생각이 들면 오래 마음에 남아요.',
    sourceId: 'riso-hudson-wisdom',
    origin: 'authored',
    reverse: false,
    rationale:
      '이미 벌어진 자기 책임의 미흡함에 걸리는 반응이어서, 앞으로 잘못될 가능성에 대비하려는 유형 6의 불안과 구분되고 유형 1의 결함 노출 두려움에 해당해요.',
    authoredBy: 'worker-items-a',
    copyrightReview: { verdict: 'clear', reviewedBy: 'worker-review', note: '"내 몫"이라는 역할 수행 어휘로 유형 4의 결여감과 구분되게 자체 작성했어요.' },
  },
  {
    id: 'q1-05',
    typeId: 1,
    facet: 't1-error-attention',
    text: '평소에 문서를 펼치면 틀린 표기나 어긋난 줄이 먼저 눈에 들어와요.',
    sourceId: 'palmer-1988',
    origin: 'authored',
    reverse: false,
    rationale:
  ...
  },
  {
    ...
    typeId: 1,
    facet: 't1-error-attention',
    text: '평소에 방에 들어서면 정리되지 않은 곳이 먼저 눈에 들어와요.',
    sourceId: 'palmer-1988',
    origin: 'authored',
    reverse: false,
    rationale:
  ...
  },
  {
    ...
    text: '평소에 남이 일하는 방식이 어긋나 보이면 그냥 넘기지 않고 짚곤 해요.',
    ...
    authoredBy: 'worker-items-a',
    copyrightReview: { verdict: 'clear', reviewedBy: 'worker-review-5', note: '타인의 작업 방식을 "그냥 넘기지 않고 짚곤 한다"는 행동 수준으로 기술해 덕목·악덕 어휘를 배제했어요.' },
  },
  {
    id: 'q1-08',
    typeId: 1,
    facet: 't1-correction-voice',
    text: '평소에 남이 나와 다른 방식으로 해도 그 방식대로 두고 봐요.',
    sourceId: 'naranjo-1994',
    origin: 'authored',
    reverse: true,
    rationale:
    ...
    authoredBy: 'worker-items-a',
    copyrightReview: { verdict: 'clear', reviewedBy: 'worker-review-5', note: 'q1-07의 반대 방향 긍정 진술이며, "그 방식대로 두고 본다"는 한국어 관용 표현으로 부정문 역문항을 피했어요.' },
  },
  {
    id: 'q1-09',
    typeId: 1,
    facet: 't1-restraint-pressure',
    text: '지난 몇 년간 대체로 감정을 드러내면 절제가 부족하다고 여겨 감정을 눌러 왔어요.',
  ...
  },
  {
    ...
    typeId: 1,
    facet: 't1-restraint-pressure',
    text: '평소에 하고 싶은 것을 미뤄 두다 속이 답답해질 때가 자주 있어요.',
    ...
    authoredBy: 'worker-items-a',
    copyrightReview: { verdict: 'clear', reviewedBy: 'worker-review', note: '욕구 유예의 답답함을 중립적 신체 감각 어휘로 서술해 악덕 언어를 피했어요.' },
  },
];
