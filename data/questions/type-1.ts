...
export const type1Questions: Question[] = [
  ...
  },
  {
    ...
    typeId: 1,
    facet: 't1-standards',
    text: '평소에 웬만한 건 대충 넘어가도 괜찮다고 느낀다.',
    sourceId: 'riso-hudson-wisdom',
    origin: 'authored',
    reverse: true,
    rationale:
    ...
    authoredBy: 'worker-items-a',
    copyrightReview: { verdict: 'clear', reviewedBy: 'worker-review', note: '기준 완화를 부정문이 아닌 반대 방향 긍정문으로 새로 쓴 역채점 문장이다.' },
  },
  {
    id: 'q1-03',
    typeId: 1,
    facet: 't1-flaw-fear',
    text: '평소에 지적을 들을 때 먼저 드는 생각은 내가 허술해 보였겠다는 것이다.',
    ...
    authoredBy: 'worker-items-a',
    copyrightReview: { verdict: 'clear', reviewedBy: 'worker-review', note: '지적 상황의 자기 인식을 "허술해 보였겠다"는 구어 표현으로 서술했고 번역투 어순이 없다.' },
  },
  {
    id: 'q1-04',
    typeId: 1,
  ...
  },
  {
    ...
    text: '평소에 문서를 볼 때 먼저 눈에 들어오는 것은 틀린 표기나 어긋난 줄이다.',
    sourceId: 'palmer-1988',
    origin: 'authored',
    reverse: false,
    rationale:
    ...
    authoredBy: 'worker-items-a',
    copyrightReview: { verdict: 'clear', reviewedBy: 'worker-review', note: '교정 대상을 "틀린 표기나 어긋난 줄"이라는 구체 명사로 지정한 주의 초점 문장이다.' },
  },
  {
    id: 'q1-06',
    typeId: 1,
    facet: 't1-error-attention',
    text: '평소에 방에 들어서면 먼저 눈에 들어오는 것은 정리되지 않은 곳이다.',
    sourceId: 'palmer-1988',
    origin: 'authored',
    reverse: false,
    rationale:
  ...
  },
  {
    ...
    text: '평소에 남이 일하는 방식이 어긋나 보이면 그냥 넘기지 않고 짚는 편이다.',
    ...
    authoredBy: 'worker-items-a',
    copyrightReview: { verdict: 'clear', reviewedBy: 'worker-review', note: '타인의 작업 방식에 개입하는 행동을 "짚는 편이다"라는 빈도 진술로 기술했다.' },
  },
  {
    id: 'q1-08',
    typeId: 1,
    facet: 't1-correction-voice',
    text: '평소에 남이 나와 다른 방식으로 해도 그 방식대로 두는 편이다.',
    sourceId: 'naranjo-1994',
    origin: 'authored',
    reverse: true,
    rationale:
    ...
    authoredBy: 'worker-items-a',
    copyrightReview: { verdict: 'clear', reviewedBy: 'worker-review', note: '개입 억제를 반대 방향 긍정문으로 쓴 역채점 문장이다.' },
  },
  {
    id: 'q1-09',
    typeId: 1,
    facet: 't1-restraint-pressure',
    text: '지난 몇 년간 대체로 감정을 드러내는 것은 절제가 부족한 일이라 여겨 눌러 왔다.',
