...
export const type3Questions: Question[] = [
  {
    ...
    text: '평소에 하루를 마칠 때 무엇을 해냈는지로 그날을 평가하는 편이다.',
  ...
  },
  {
    ...
    text: '평소에 또래보다 뒤처져 보일까 봐 신경이 쓰이는 편이다.',
    sourceId: 'riso-hudson-wisdom',
    origin: 'authored',
    reverse: false,
    rationale:
  ...
  },
  {
    ...
    typeId: 3,
    facet: 't3-failure-image-fear',
    text: '평소에 일이 잘 안 풀릴 때 먼저 드는 생각은 남들 눈에 어떻게 비칠까 하는 것이다.',
  ...
  },
  {
    ...
    text: '평소에 새 일을 맡으면 먼저 눈에 들어오는 것은 무엇이 성과로 쳐주는지다.',
    sourceId: 'palmer-1988',
    origin: 'authored',
    reverse: false,
    rationale:
  ...
  },
  {
    ...
    typeId: 3,
    facet: 't3-efficiency-attention',
    text: '평소에 방법이 여럿일 때 먼저 눈에 들어오는 것은 가장 빠른 길이다.',
    sourceId: 'palmer-1988',
    origin: 'authored',
    reverse: false,
    rationale:
  ...
  },
  {
    ...
    text: '평소에 자리에 따라 말투나 보여주는 모습을 다르게 맞추는 편이다.',
  ...
  },
  {
    ...
    typeId: 3,
    facet: 't3-impression-tuning',
    text: '평소에 상대가 누구든 말투와 태도를 바꾸지 않는 편이다.',
    sourceId: 'naranjo-1994',
    origin: 'authored',
    reverse: true,
    rationale:
