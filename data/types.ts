...
export const types: EnneagramType[] = [
  {
    ...
    summary:
      '무엇이 옳고 제대로 된 상태인지에 대한 내적 기준이 뚜렷하고, 그 기준에 자기 자신을 먼저 맞춰요. 대충 넘어가는 것을 불편해하며 고칠 수 있는 것은 고쳐 두려 해요.',
    coreMotivation:
      '옳은 방식으로 살고, 자기 몫을 제대로 해내고, 주변의 어긋난 것을 바로잡아 떳떳해지고 싶어요.',
    coreFear:
      '자신이 결함이 있거나 무책임한 사람이라는 것이 드러나는 것. 기준을 놓으면 자기가 흐트러질 것 같은 감각.',
    strengths: [
      '맡은 일을 끝까지 정확하게 마무리해요',
      '원칙과 약속을 지켜 주변이 그를 믿고 맡길 수 있어요',
      '무엇이 잘못됐는지 빠르게 알아보고 개선안을 내요',
      '자기에게 먼저 엄격해 말과 행동이 어긋나지 않아요',
    ],
    growthPoints: [
  ...
  },
  {
    ...
    summary:
      '주변 사람의 기분과 필요를 빠르게 알아채고 먼저 움직여요. 관계 안에서 도움이 되는 존재일 때 자기 자리를 확인해요.',
    coreMotivation:
      '가까운 사람에게 필요한 존재가 되고, 그 관계 안에서 사랑받고 있다는 것을 확인하고 싶어요.',
    coreFear:
      '자기가 아무에게도 필요하지 않아 관계 밖으로 밀려나는 것. 줄 것이 없으면 그대로는 환영받지 못할 것 같은 감각.',
    strengths: [
      '상대가 말하지 않은 필요까지 알아채요',
      '먼저 다가가 관계의 물꼬를 터요',
      '따뜻하고 구체적인 방식으로 사람을 도와요',
      '집단 안에서 소외된 사람을 잘 챙겨요',
    ],
    growthPoints: [
  ...
  },
  {
    ...
    summary:
      '목표를 세우고 결과를 만들어 내는 데 에너지가 집중돼요. 상황에서 무엇이 성과로 인정받는지를 빠르게 읽고 거기에 자기를 맞춰요.',
    coreMotivation:
      '눈에 보이는 성과를 내고 유능한 사람으로 인정받아 자기 가치를 확인하고 싶어요.',
    coreFear:
      '실패하거나 뒤처져 별 볼 일 없는 사람으로 보이는 것. 성과를 빼면 남는 것이 없을 것 같은 감각.',
    strengths: [
      '목표를 현실적인 단계로 쪼개 실제로 굴러가게 만들어요',
      '에너지가 높고 회복이 빨라 중간에 멈추지 않아요',
      '상황에 필요한 역할을 빠르게 파악해 적응해요',
      '팀에 추진력과 방향 감각을 줘요',
    ],
    growthPoints: [
  ...
  },
  {
    ...
    nameEn: 'Depth Seeker',
    summary:
      '자기 감정의 결과 자기만의 고유함에 민감하고, 표면적인 것으로는 만족하지 못해요. 남과 자기를 비교하며 무엇이 다른지를 자주 의식해요.',
    coreMotivation:
      '자기다운 것을 잃지 않고, 자기 감정과 경험에 솔직하게 살면서 있는 그대로 이해받고 싶어요.',
    coreFear:
      '다른 사람에게는 있는 무언가가 자기에게는 빠져 있어서, 결국 평범하게 묻히거나 끝내 이해받지 못하는 것.',
    strengths: [
      '자기 감정과 남의 감정의 미묘한 결을 알아봐요',
      '남들이 피하는 무겁고 어려운 이야기를 함께 있어 줘요',
      '표현·취향·관점에 자기만의 색이 있어요',
      '겉치레를 걷어낸 진짜 대화를 만들어요',
    ],
    growthPoints: [
  ...
  },
  {
    ...
    summary:
      '한발 떨어져 관찰하고 이해한 뒤에 움직여요. 시간·에너지·사적인 공간을 소모하는 요구에 민감하고, 혼자 있는 시간으로 충전해요.',
    coreMotivation:
      '충분히 알고 준비된 상태에서, 자기 힘으로 감당할 수 있는 만큼만 관여하며 살고 싶어요.',
    coreFear:
      '가진 것이 바닥나 요구에 휩쓸리고, 결국 무능하고 무력한 상태로 남겨지는 것.',
    strengths: [
      '감정에 휩쓸리지 않고 상황을 침착하게 봐요',
      '관심 있는 주제를 깊이 파고들어 남다른 이해에 이르러요',
      '군더더기 없이 필요한 만큼만 말하고 써요',
      '자기 힘으로 문제를 해결하는 독립성이 있어요',
    ],
    growthPoints: [
  ...
  },
  {
    ...
    nameEn: 'Risk Scanner',
    summary:
      '잘못될 수 있는 지점이 먼저 보이고, 그것에 대비해 두어야 마음이 놓여요. 믿을 만한 사람과 기반을 확보하는 데 에너지를 써요.',
    coreMotivation:
      '기댈 수 있는 기반과 신뢰할 수 있는 관계를 확보해, 무슨 일이 생겨도 감당할 수 있는 상태가 되고 싶어요.',
    coreFear:
      '의지할 데 없이 혼자 남아 감당 못 할 상황을 맞는 것. 믿었던 것이 실은 안전하지 않았던 것으로 드러나는 것.',
    strengths: [
      '남들이 못 본 위험과 허점을 미리 짚어내요',
      '한번 믿은 사람과 약속에 오래 성실해요',
      '최악의 경우까지 계산해 현실적인 대비책을 만들어요',
      '집단 안에서 책임을 회피하지 않아요',
    ],
    growthPoints: [
  ...
  },
  {
    ...
    summary:
      '재미있어 보이는 것과 해볼 만한 것이 먼저 눈에 들어와요. 선택지를 넓게 열어 두고, 분위기가 무거워지면 가볍게 만드는 쪽으로 움직여요.',
    coreMotivation:
      '좋은 경험과 가능성을 놓치지 않고, 답답함에 갇히지 않은 채 자유롭게 움직이고 싶어요.',
    coreFear:
      '지루하고 답답한 상태에 갇혀, 하고 싶은 것도 기대할 것도 없이 결핍된 채로 있는 것.',
    strengths: [
      '막힌 상황에서 새로운 선택지를 잘 떠올려요',
      '회복이 빠르고 주변 분위기를 밝게 만들어요',
      '여러 분야를 빠르게 배우고 연결해요',
      '시작하는 일을 두려워하지 않아요',
    ],
    growthPoints: [
  ...
  },
  {
    ...
    summary:
      '상황을 남에게 맡겨두기보다 자기가 쥐고 가려고 해요. 할 말을 직접 하고, 자기 사람이라고 여기는 쪽을 앞에서 막아서요.',
    coreMotivation:
      '자기 삶과 상황의 결정권을 스스로 쥐고, 자기 사람을 지킬 수 있는 힘을 갖고 싶어요.',
    coreFear:
      '남에게 휘둘리거나 약점을 잡혀 통제당하는 것. 힘을 놓으면 당하는 쪽이 될 것 같은 감각.',
    strengths: [
      '아무도 나서지 않을 때 먼저 결정하고 책임져요',
      '불편한 말을 돌리지 않고 분명하게 전해요',
      '부당한 일에 눈감지 않고 약한 쪽을 막아서요',
      '에너지가 크고 압박 속에서도 흔들리지 않아요',
    ],
    growthPoints: [
  ...
  },
  {
    ...
    summary:
      '여러 사람의 입장이 동시에 보이고, 마찰이 생기는 쪽으로는 잘 가지 않는다. 편안한 상태가 유지되는 것이 중요해 자기 주장은 뒤로 미루기 쉬워요.',
    coreMotivation:
      '주변과 자기 안이 모두 평온한 상태를 유지하고, 관계가 흔들리지 않게 지키고 싶어요.',
    coreFear:
      '갈등으로 관계가 끊어지고 자기 자리가 사라지는 것. 자기 의견을 내세우면 균형이 깨질 것 같은 감각.',
    strengths: [
      '서로 다른 입장을 동시에 이해하고 중재해요',
      '함께 있는 사람을 편안하게 만들어요',
      '급한 상황에서도 쉽게 흥분하지 않아요',
      '판단을 앞세우지 않고 있는 그대로 들어줘요',
    ],
    growthPoints: [
...
export const facets: FacetDef[] = [
  // 유형 1
  { id: 't1-standards', typeId: 1, kind: 'motivation', description: '제대로 해두려는 내적 기준과 자기 규율 — 결과의 인정 여부와 무관하게 작동해요.' },
